<template>
  <view class="container">
    ...
    <view v-for="batch in batches" :key="batch.id" class="card" @click="select(batch.id)">
...
function select(id){store.selectBatch(id);uni.switchTab({url:'/pages/home/index'});}
